...
//------------------------------------------------------------------------------
/**
  Переопределенный метод для обработки движения колесика мыши
*/
//---
void SceneWidget::wheelEvent(QWheelEvent * event)
{
  emit CreatedQWheelEvent(event);
}


//------------------------------------------------------------------------------
/**
  Переопределенный метод для нажатия кнопок мыши мыши
*/
//---
void SceneWidget::keyPressEvent(QKeyEvent* event)
{
  emit CreatedQKeyEvent(event);
}
